...
export const ITEM_STATUSES = {
  ...
  returned: { label: "Returned", color: "bg-green-100 text-green-800 border-green-200" },
...
export const CLAIM_STATUSES = {
  ...
  need_more_info: { label: "Need More Info", color: "bg-orange-100 text-orange-800 border-orange-200" },
  approved: { label: "Approved", color: "bg-emerald-100 text-emerald-800 border-emerald-200" },
...
export const LOST_REPORT_STATUSES = {
  ...
  matched: { label: "Matched", color: "bg-purple-100 text-purple-800 border-purple-200" },
